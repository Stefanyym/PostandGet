...
<body>
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="masukandansaran.php">Masukan dan Saran</a>
                </li>
            </ul>
        </nav>
        <!-- Page Content  -->
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" >KRITIK DAN SARAN</a>
                            </li>
                            </li>
                        </ul>
                    </div>
    ...
    <form name="" action="proses_post.php" method="post">
        ...
        <table> 
            ...
            <textarea class="form-control" name="kritikdansaran" rows="3"></textarea>
            </div>
            </tr>
            <tr>
                <td><input type ="submit" class= "btn btn-primary" value="simpan" name="tombol"></td>
            </tr>
        </table>
        </fieldset>
    </form>
