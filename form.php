    ...
    <div class="wrapper">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="#">IDENTITAS PENGGUNA</a>
                            </li>
                            </li>
                        </ul>
                    </div>
        ...
        <table> 
            ...
            <tr>
                <td> Tanggal Lahir </td>
                <td> : </td>
                <td> <input type= "date(Y/m/d)"  name="tanggallahir"> </td>
            </tr> 
            <tr>
                <td>Umur</td>
                <td> : </td>
            ...
            <tr>
                <td colspan="7"><input type ="submit" class= "btn btn-primary" value="simpan" name="tombol"></td>
            </tr>
